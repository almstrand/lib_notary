 ...
 */
class GoogleCloudRequestFormData {
  ...
  GoogleCloudRequestFormData(String this.key, String this.GoogleAccessId, String this.policy, String this.signature);
}
 ...
 */
class GoogleCloudSignedRequest {
   ...
   */
  GoogleCloudRequestFormData requestFormData;

  /**
   * Construct new signed request.
   */
  GoogleCloudSignedRequest(String this.url, int this.expiration, { GoogleCloudRequestFormData this.requestFormData : null});
}

/**
 * Defines methods to sign Google Cloud Storage file upload/download requests.
 */
class GoogleCloudNotary {
   ...
   */
  static Future<GoogleCloudSignedRequest> signGetRequest(String GoogleAccessId, String pemFilePath, int expirationSeconds, String bucketName, String key, { String contentMD5 : "", String contentType : "", String canonicalizedExtensionHeaders : "", bool useSSL : true, bool cachePrivateKeys : true }) {

    // Completer used to defer signing request until private key file has been read
    Completer<GoogleCloudSignedRequest> urlSigningCompleter = new Completer<GoogleCloudSignedRequest>();
    ...
    _getPrivateKey(pemFilePath, cachePrivateKeys).catchError((Object error) {
      ...
      if (privateKey == null) {
        ...
        GoogleCloudSignedRequest signedRequest = new GoogleCloudSignedRequest(url, expirationEpochTimeSeconds);
   ...
   *      Optional. Set to true to cache private keys and improve speed performance of signing subsequent requests.
   */
  static Future<GoogleCloudSignedRequest> signPostRequest(String GoogleAccessId, String pemFilePath, int expirationSeconds, String bucketName, String key, String acl, { bool useSSL : true, bool cachePrivateKeys : true }) {
    ...
    _getPrivateKey(pemFilePath, cachePrivateKeys).catchError((Object error) {
      ...
      if (privateKey != null) {
        ...
        GoogleCloudRequestFormData requestFormData = new GoogleCloudRequestFormData(key, GoogleAccessId, base64EncodedPolicyDocument, base64EncodedPolicyDocumentSignature);

        // Instantiate signed request object
        GoogleCloudSignedRequest signedRequest = new GoogleCloudSignedRequest(url, expirationTimeSinceEpochMillis ~/ 1000, requestFormData : requestFormData);
